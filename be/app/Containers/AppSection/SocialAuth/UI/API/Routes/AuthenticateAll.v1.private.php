 ...
 * @apiPermission      none
 * 
 * @apiParam           {String="google"} provider
 * @apiBody            {String} oauth_token  token provided by the social provider
 *
 * @apiSuccessExample  {json}    Success-Response:
HTTP/1.1 200 OK
{
    // here we will return a User transformer response + some custom meta data
    // you can set the transformer in appSection-socialAuth config (you have to publish it first -> appSection:publish)
 .
 .
 .
    "meta": {
