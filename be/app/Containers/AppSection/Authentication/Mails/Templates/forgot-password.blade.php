...
<head>
    ...
    <meta name="description" content="Khôi phục mật khẩu">
    <style type="text/css">
                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    ...
                                    <a href="{{$reseturl}}?email={{$email}}&token={{$token}}"
                                       style="background:#20e277;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Khôi phục mật khẩu tại đây</a>
                                </td>
                            </tr>
                            <tr>
                                <td style="height:40px;">&nbsp;</td>
