...
class RenderTemplatesTask extends Task
{
    ...
    {
        $this->templatePath = 'Containers/' . config('writtenSection-documentation.section_name') . '/Documentation/ApiDocJs/shared/header.template'.config('writtenSection-documentation.locale', 'en').'.md';
        $this->outputPath = 'Containers/' . config('writtenSection-documentation.section_name') . '/Documentation/UI/WEB/Views/documentation/header.md';
        $this->replaceArray = [
